...
- [x] **Phase 9: HubSpot Campaign Command Foundation** - Define HubSpot campaign command surface, campaign model, and lifecycle scaffolding.
- [x] **Phase 10: Copy Approval Artifact and Gate Engine** - Add required human copy approvals with invalidation-on-edit behavior.
...
Plans:
- [x] 09-01-PLAN.md -- Add HubSpot campaign command routing and action translation
- [x] 09-02-PLAN.md -- Add campaign persistence model and lifecycle state helpers
...
Plans:
- [x] 10-01-PLAN.md -- Add copy approval artifact schema and approval commands
- [x] 10-02-PLAN.md -- Add approval invalidation and status/diff reporting
...
|-------|----------------|--------|-----------|
| 9. HubSpot Campaign Command Foundation | 2/2 | Complete | 2026-03-04 |
| 10. Copy Approval Artifact and Gate Engine | 2/2 | Complete | 2026-03-04 |
